...
var Button = exports.Button = function Button(props) {
  return _react2.default.createElement('button', _extends({}, (0, _utils.removeProps)(props, ['color']), { className: createButtonClassName(props) }));
};
...
var Link = exports.Link = function Link(props) {
  return _react2.default.createElement('a', _extends({}, (0, _utils.removeProps)(props, ['color']), { className: createButtonClassName(props) }));
};
